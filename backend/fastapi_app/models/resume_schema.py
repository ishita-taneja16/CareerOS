...
class ContactInfo(BaseModel):
    ...
    location: Optional[str] = Field(default=None, description="City, state, or country of residence")
...
class ExperienceItem(BaseModel):
    ...
    location: Optional[str] = Field(default=None, description="Location of company (e.g., San Francisco, CA or Remote)")
...
class EducationItem(BaseModel):
    ...
    location: Optional[str] = Field(default=None, description="Location of school")
